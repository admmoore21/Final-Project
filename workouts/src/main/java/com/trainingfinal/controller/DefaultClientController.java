...
public class DefaultClientController implements ClientController {
	...
	public Optional<Client> createClient(String firstName, String lastName, 
			Integer phone, Proficiency proficiency) {
	...
	// Put/Update Client
	@Override
	public Optional<Client> updateClient(String firstName, String lastName, Integer phone, 
			Proficiency proficiency, String newFirstName, String newLastName, Integer newPhone, 
